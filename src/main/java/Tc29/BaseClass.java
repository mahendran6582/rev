...
public class BaseClass {
	...
	@BeforeClass(groups = {"Master", "Regression", "DataDriver"})
	@Parameters({"os", "br"})
	public void homepage(String os, String br) throws IOException {
		
		FileReader file = new FileReader("./src/main/java/Tc29/config.properties");
		p = new Properties();
		p.load(file);
	...
	@AfterClass(groups = {"Master", "Regression", "DataDriver"})
